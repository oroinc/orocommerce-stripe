 ...
 */
class PaymentIntentSucceededChargeStripeActionExecutor implements
    ...
    LoggerAwareInterface
{
    ...
    public function executeAction(
        ...
        $chargeTransaction->setAmount($paymentIntentAmount);
        $chargeTransaction->setCurrency($paymentIntentCurrency);
        $chargeTransaction->setActive(false);
        $chargeTransaction->setSuccessful(true);
