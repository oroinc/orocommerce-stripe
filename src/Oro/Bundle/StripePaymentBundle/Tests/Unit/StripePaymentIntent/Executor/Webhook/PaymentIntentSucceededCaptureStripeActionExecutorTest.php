...
use Oro\Bundle\StripePaymentBundle\StripePaymentIntent\Executor\Webhook\PaymentIntentSucceededCaptureStripeActionExecutor;
 ...
 */
final class PaymentIntentSucceededCaptureStripeActionExecutorTest extends TestCase
{
    use LoggerAwareTraitTestTrait;

    private PaymentIntentSucceededCaptureStripeActionExecutor $executor;
    ...
    protected function setUp(): void
    {
        ...
        $this->executor = new PaymentIntentSucceededCaptureStripeActionExecutor(
    ...
    public function testIsSupportedByActionNameReturnsFalseWhenSupportedAction(): void
    {
        self::assertTrue(
            $this->executor->isSupportedByActionName(
                PaymentIntentSucceededCaptureStripeActionExecutor::ACTION_NAME
            )
        );
    }
