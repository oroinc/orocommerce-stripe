...
final class ChargeStripeActionExecutorTest extends TestCase
{
    ...
    {
        $chargeTransaction = $this->createChargeTransaction(PaymentMethodInterface::CHARGE, []);
    ...
    {
        $chargeTransaction = $this->createChargeTransaction(PaymentMethodInterface::CHARGE, $confirmationToken);
    ...
    public function testIsApplicableForActionReturnsTrueWhenPurchaseWithAutomaticCapture(): void
    {
        $stripeAction = new StripePaymentIntentAction(
    ...
    public function testIsApplicableForActionReturnsTrueWhenPurchaseWithPaymentMethodTypeNotInManualCapture(): void
    {
        $confirmationToken = [
            'id' => 'con_123',
            'paymentMethodPreview' => [
        ...
        $chargeTransaction = $this->createChargeTransaction(PaymentMethodInterface::PURCHASE, $confirmationToken);
    ...
    public function testIsApplicableForActionReturnsFalseWhenPurchaseWithPaymentMethodTypeInManualCapture(): void
    {
        $confirmationToken = [
            'id' => 'con_123',
            'paymentMethodPreview' => [
    ...
    public function testExecuteActionWithSetupFutureUsage(): void
    {
        $paymentTransaction = $this->createChargeTransaction();
        ...
        $requestArgs = [
            [
                ...
                'customer' => self::STRIPE_CUSTOMER_ID,
                // Setup future usage should be set to off_session when the corresponding option is enabled.
