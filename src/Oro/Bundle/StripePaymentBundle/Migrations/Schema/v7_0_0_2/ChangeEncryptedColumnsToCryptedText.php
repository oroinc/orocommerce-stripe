...
namespace Oro\Bundle\StripePaymentBundle\Migrations\Schema\v7_0_0_2;
...
/**
 * Converts Stripe Payment Element encrypted credential columns from crypted_string (VARCHAR(255)) to
 * crypted_text (TEXT) to fit AES-encrypted values that exceed 255 chars.
 */
class ChangeEncryptedColumnsToCryptedText implements Migration
{
    ...
    public function up(Schema $schema, QueryBag $queries): void
    {
        ...
        $this->changeColumnToCryptedText($table, 'stripe_payment_element_api_secret_key');
        $this->changeColumnToCryptedText($table, 'stripe_payment_element_webhook_secret');
    }
