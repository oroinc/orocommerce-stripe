...
const StripeAppleGooglePaySelectionComponent = BaseComponent.extend({
    defaults: {
        selector: {
            ...
            existingLabelTextSelector: '.custom-radio__text',
    ...
    changePaymentOptionLabel(paymentViewElementId) {
        ...
        const existingLabel = $(this.paymentElement).find(this.options.selector.methodLabelSelector)
            .find(this.options.selector.existingLabelTextSelector);
