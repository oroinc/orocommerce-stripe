...
class PaymentAmountConverterTest extends TestCase
{
    ...
    public function testConvertToStripeFormat(array $currencies, mixed $amount, int $expected): void
    {
        foreach ($currencies as $currency) {
            $this->assertEquals($expected, PaymentAmountConverter::convertToStripeFormat($amount, $currency));
        }
    }
    ...
    {
        foreach ($currencies as $currency) {
            $this->assertEquals($expected, PaymentAmountConverter::convertFromStripeFormat($amount, $currency));
        }
    }
    ...
    public function testConvertToStripeFormatWithNull(): void
    {
        ...
        PaymentAmountConverter::convertToStripeFormat(null, 'USD');
    }

    public function testConvertToStripeFormatWithString(): void
    {
        $this->expectException(TypeError::class);
        PaymentAmountConverter::convertToStripeFormat('');
    }
