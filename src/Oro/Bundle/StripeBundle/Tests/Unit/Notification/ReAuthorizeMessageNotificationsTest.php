...
class ReAuthorizeMessageNotificationsTest extends TestCase
{
    ...
    private StripeNotificationManager|\PHPUnit\Framework\MockObject\MockObject $notificationManager;
    private DateTimeFormatterInterface|\PHPUnit\Framework\MockObject\MockObject $dateTimeFormatter;
